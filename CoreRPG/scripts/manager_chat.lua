...
function registerSlashCommand(sCommand, fCallback, vParamHelp)
	...
	ChatManager.SystemMessage("ChatManager.registerSlashCommand - DEPRECATED - 2022-07-12 - Contact forge/extension author");
...
function unregisterSlashCommand(sCommand)
	...
	ChatManager.SystemMessage("ChatManager.unregisterSlashCommand - DEPRECATED - 2022-07-12 - Contact forge/extension author");
...
function onSlashCommand(sCommand, sParams)
	...
	ChatManager.SystemMessage("ChatManager.onSlashCommand - DEPRECATED - 2022-07-12 - Contact forge/extension author");
end
