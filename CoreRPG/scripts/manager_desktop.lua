...
function registerSidebarStackButton(tButton, vInsertAt)
	Debug.console("DesktopManager.registerSidebarStackButton - DEPRECATED - 2023-04-11 - Use DesktopManager.registerSidebarToolButton");
	registerSidebarToolButton(tButton, vInsertAt);
end
