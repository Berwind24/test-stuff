...
function createWidgets(sIdentity)
	...
	namewidget = addTextWidget({
		...
		frame = "mini_name", frameoffset="5,2,5,2", w = 90 
	});
	
	statewidget = addBitmapWidget({ position="topleft", x = 23, y = 22 });
	
	colorwidget = addBitmapWidget({ icon = "charlist_pointer", x = 50, y = 31 });
