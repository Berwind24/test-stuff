...
function initDisplayData()
	if parameters then
		if parameters[1].icons then
			_tIcons = StringManager.split(parameters[1].icons[1], "|");
		end
		if parameters[1].values then
			_tValues = StringManager.split(parameters[1].values[1], "|");
		end
		...
		elseif parameters[1].tooltips then
			_tTooltips = StringManager.split(parameters[1].tooltips[1], "|");
		end
