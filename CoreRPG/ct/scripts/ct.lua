...
function toggleTargeting()
	...
	ChatManager.SystemMessage("ct.lua:toggleTargeting - DEPRECATED - 2022-08-16 - Contact ruleset/extension/forge author");
end
function toggleAttributes()
	Debug.console("ct.lua:toggleAttributes - DEPRECATED - 2022-08-16");
	ChatManager.SystemMessage("ct.lua:toggleAttributes - DEPRECATED - 2022-08-16 - Contact ruleset/extension/forge author");
end
function toggleActive()
	Debug.console("ct.lua:toggleActive - DEPRECATED - 2022-08-16");
	ChatManager.SystemMessage("ct.lua:toggleActive - DEPRECATED - 2022-08-16 - Contact ruleset/extension/forge author");
end
function toggleDefensive()
	Debug.console("ct.lua:toggleDefensive - DEPRECATED - 2022-08-16");
	ChatManager.SystemMessage("ct.lua:toggleDefensive - DEPRECATED - 2022-08-16 - Contact ruleset/extension/forge author");
end
function toggleSpacing()
	Debug.console("ct.lua:toggleSpacing - DEPRECATED - 2022-08-16");
	ChatManager.SystemMessage("ct.lua:toggleSpacing - DEPRECATED - 2022-08-16 - Contact ruleset/extension/forge author");
end
function toggleEffects()
	Debug.console("ct.lua:toggleEffects - DEPRECATED - 2022-08-16");
	ChatManager.SystemMessage("ct.lua:toggleEffects - DEPRECATED - 2022-08-16 - Contact ruleset/extension/forge author");
end
function onEntrySectionToggle()
	Debug.console("ct.lua:onEntrySectionToggle - DEPRECATED - 2022-08-16");
	ChatManager.SystemMessage("ct.lua:onEntrySectionToggle - DEPRECATED - 2022-08-16 - Contact ruleset/extension/forge author");
end
