...
function setTargetingVisible()
	...
	ChatManager.SystemMessage("ct_entry.lua:setTargetingVisible - DEPRECATED - 2022-08-16 - Contact ruleset/extension/forge author");
end
function setActiveVisible()
	self.onSectionChanged("active");
	ChatManager.SystemMessage("ct_entry.lua:setActiveVisible - DEPRECATED - 2022-08-16 - Contact ruleset/extension/forge author");
end
function setDefensiveVisible()
	self.onSectionChanged("defense");
	ChatManager.SystemMessage("ct_entry.lua:setDefensiveVisible - DEPRECATED - 2022-08-16 - Contact ruleset/extension/forge author");
end
function setAttributesVisible()
	self.onSectionChanged("attributes");
	ChatManager.SystemMessage("ct_entry.lua:setAttributesVisible - DEPRECATED - 2022-08-16 - Contact ruleset/extension/forge author");
end
function setSpacingVisible(v)
	self.onSectionChanged("spacing");
	ChatManager.SystemMessage("ct_entry.lua:setSpacingVisible - DEPRECATED - 2022-08-16 - Contact ruleset/extension/forge author");
end
function setEffectsVisible(v)
	self.onSectionChanged("effects");
	ChatManager.SystemMessage("ct_entry.lua:setEffectsVisible - DEPRECATED - 2022-08-16 - Contact ruleset/extension/forge author");
end
